...
public class PagamentoDataInitializer {
    ...
    public void executeDmlAfterStartup() {
        ...
        List<PagamentoEntity> pagamentos = List.of(
                ...
                createPagamento(1002L, "12345678901", MetodoPagamento.PIX, null, new BigDecimal("89.90"), StatusPagamento.PENDENTE_PROCESSAMENTO, LocalDateTime.now()),
                ...
                createPagamento(1004L, "11223344556677", MetodoPagamento.PIX, null, new BigDecimal("45.50"), StatusPagamento.PENDENTE_PROCESSAMENTO, LocalDateTime.now()),
                createPagamento(1005L, "4444555566667", MetodoPagamento.CARTAO_CREDITO, "4444555566667777", new BigDecimal("120.00"), StatusPagamento.PROCESSADO_SUCESSO, LocalDateTime.now()),
                createPagamento(1006L, "98765432109", MetodoPagamento.PIX, null, new BigDecimal("75.20"), StatusPagamento.PENDENTE_PROCESSAMENTO, LocalDateTime.now()),
                ...
                createPagamento(1008L, "09876543210", MetodoPagamento.PIX, null, new BigDecimal("60.00"), StatusPagamento.PENDENTE_PROCESSAMENTO, LocalDateTime.now()),
                createPagamento(1009L, "4777888899990", MetodoPagamento.CARTAO_CREDITO, "4777888899990000", new BigDecimal("95.75"), StatusPagamento.PROCESSADO_SUCESSO, LocalDateTime.now()),
                createPagamento(1010L, "12312312312", MetodoPagamento.PIX, null, new BigDecimal("180.00"), StatusPagamento.PENDENTE_PROCESSAMENTO, LocalDateTime.now()),
                createPagamento(1011L, "5555666677778", MetodoPagamento.CARTAO_CREDITO, "5555666677778888", new BigDecimal("250.00"), StatusPagamento.PROCESSADO_SUCESSO, LocalDateTime.now()),
                ...
                createPagamento(1013L, "6222333344445", MetodoPagamento.CARTAO_DEBITO, "6222333344445555", new BigDecimal("175.50"), StatusPagamento.PROCESSADO_SUCESSO, LocalDateTime.now()),
    ...
    private PagamentoEntity createPagamento(Long codigoDebito, String identificacaoPagador, MetodoPagamento metodoPagamento, String numeroCartao, BigDecimal valorPagamento, StatusPagamento statusPagamento, LocalDateTime dataPagamento) {
        PagamentoEntity pagamento = new PagamentoEntity();
        pagamento.setCodigoDebito(codigoDebito);
        pagamento.setIdentificacaoPagador(identificacaoPagador);
